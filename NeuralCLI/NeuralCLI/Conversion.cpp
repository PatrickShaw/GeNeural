...
namespace NeuralCLI {
  class Conversion {
    generic <typename T> static std::shared_ptr<std::vector<T>> Conversion::array_to_vector(array<T>^ cliArray) {
    ...
    generic <typename T> array<T>^ Conversion::vector_to_array(const std::vector<T>& vector) {
